...
var logUnderscoreVersion = require('./modOne');

var helloWorld = require('./modTwo');

var modularCode = require('./modThree');

logUnderscoreVersion();
helloWorld();
modularCode();
},{"./modOne":3,"./modThree":4,"./modTwo":5}],3:[function(require,module,exports){
'use srtict';
